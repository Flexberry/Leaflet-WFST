...
var b=L.XmlUtil.createElementNS("wfs:Delete",{typeName:this.options.typeNSName}),c=new L.Filter.GmlObjectID(a.feature.id);return b.appendChild(L.filter(c)),b}})}(window,document);