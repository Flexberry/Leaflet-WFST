        ...
        concat: {
            ...
            main: {
                src: [
                    ...
                    '<%= srcPath %>/Format/Parsers/Layers/AbstractMultiPolylineParser.js',
                    '<%= srcPath %>/Format/Parsers/Layers/AbstractMultiPolygonParser.js',
                    '<%= srcPath %>/Format/Parsers/Layers/MultiLineStringParser.js',
                    '<%= srcPath %>/Format/Parsers/Layers/MultiCurveParser.js',
                    '<%= srcPath %>/Format/Parsers/Layers/MultiPolygonParser.js',
                    '<%= srcPath %>/Format/Parsers/Layers/MultiSurfaceParser.js',
